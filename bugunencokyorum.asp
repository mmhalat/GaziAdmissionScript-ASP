...
<head>
<title>Bug&uuml;n En &Ccedil;ok Yorum Alanlar - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bugün En &Ccedil;ok Yorumlananlar</strong></span><img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Fakülteler Gösteriliyor. </span></td>
            </tr>
          </table>
		  <%
		set tiraf = server.createobject("adodb.recordset")
sql="SELECT t.id, t.gonderen, t.ek, t.fakulte, t.tarih, t.baslik, t.icerik, t.populasyon, t.girenid, IIF(ISNULL(ty.yorumsayisi), 0, ty.yorumsayisi) FROM tiraf AS t LEFT JOIN (SELECT tirafid , COUNT(id) AS yorumsayisi FROM Yorum GROUP BY tirafid) AS ty ON t.id=ty.tirafid WHERE t.tarih = Date() ORDER BY ty.yorumsayisi DESC"
		...
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="left" class="yazi"><strong><%=tiraf.fields("gonderen")%></strong><strong> - <%=tiraf.fields("ek")%> - <strong><font color="#CC0000"><%=tiraf.fields("fakulte")%></font> </strong></strong></td>
            <td colspan="4" class="yazi"><div align="right"><%=tiraf.fields("tarih")%></div></td>
          </tr>
          <tr>
            <td height="5" colspan="6" class="yazi">&nbsp;</td>
            </tr>
          <tr>
            <td colspan="6"><div align="left"><span class="style4 style10"><%=tiraf.fields("baslik")%></span></div></td>
          </tr>
          <tr>
            <td colspan="6"><div align="left" class="yazi"><%=tiraf.fields("icerik")%></div></td>
          </tr>
          <tr>
            <td colspan="6">&nbsp;</td>
          </tr>
		  ...
		  <table width="190" height="464" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi"><strong>Fakülte Seç :</strong>
                 <FORM action="bugunfakultesec.asp" method="post">
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="bugunenpopuler.asp">En Popülerler </a></div>
              </div></td>
            </tr>
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buguneneski.asp">En Eskiler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="bugunenpopusuz.asp">En Popüsüzler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="bugunencokyorum.asp">En Çok Yorumlananlar </a></div>
              </div></td>
            </tr>
            <tr>
