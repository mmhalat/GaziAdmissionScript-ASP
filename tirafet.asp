...
<head>
<title>Tiraf Ediliyor - Gazitiraf.net</title>
    ...
    <table width="750" height="1148" border="0" cellpadding="0" cellspacing="0" bgcolor="#efefef">
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Tiraf G&ouml;nderme Aracý</strong></span></td>
            </tr>
          </table>
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <form action="tirafkaydet.asp" class="uniForm" method="post">
              <div id="errorMsg">
                <h3>G&ouml;ndermeden &Ouml;nce;</h3>
          <ol>
            <li>Sitemizin kalitesi  i&ccedil;in g&ouml;nderdiðin i&ccedil;eriðin edit&ouml;rlerimiz tarafýndan kontrol edildiðini unutma, yazdýklarýndan sen sorumlusun.</li>
            <li>Noktalamaya dikkat ettiðini biliyorum, sonu&ccedil;ta gazidensin.</li>
          </ol>
    </div>
      ...
      <fieldset>
        <div class="ctrlHolder">
          <label for=""><em>*</em> Baþlýk</label>
          <input name="baslik" id="" data-default-value="Placeholder text" size="35" maxlength="50" type="text" class="textInput large"/>

    </div>
    
        <div class="ctrlHolder noLabel">
          <ul>
            <li><label for=""><input id="" name="anonimgonder" data-default-value="Placeholder text" type="checkbox"/>
            Bu Tirafýmý Anonim Olarak G&ouml;nder.
            </label></li>
          </ul>
        </div>
        <div class="ctrlHolder">
          <label for=""><em>*</em> Tirafým</label>
          <textarea name="icerik" id="" rows="25" cols="25"></textarea>

      </div>
        <div id="okMsg">
          <p>
          Formu G&ouml;ndermen, KoþullarýOkuduðunu ve Kabul Ettiðini G&ouml;sterir.</p>

    </div>
      </fieldset>
                      <div class="buttonHolder">
        <button type="submit" class="primaryAction">Gönder Gitsin</button>
      </div>
      <fieldset class="inlineLabels">
        ...
        <%else%>
          ...
          <ol>
            <li>Sitemizin kalitesi  i&ccedil;in g&ouml;nderdiðin i&ccedil;eriðin edit&ouml;rlerimiz tarafýndan kontrol edildiðini unutma, yazdýklarýndan sen sorumlusun.</li>
            <li>Siteye kayýtlý olmadýðýn i&ccedil;in tirafýn Anonim olarak g&ouml;r&uuml;nt&uuml;lenecek ayrýca noktalamaya dikkat ettiðini biliyorum, sonu&ccedil;ta gazidensin.</li>
          </ol>
    </div>
      ...
      <fieldset>
        <div class="ctrlHolder">
          <label for=""><em>*</em> Baþlýk</label>
          <input name="baslik" id="baslik" size="66"/>
    </div>
        <div class="ctrlHolder">
          <label for=""><em>*</em> Tirafým</label>
        ...
        <div id="okMsg">
        <p>Formu G&ouml;ndermen, Koþullarý Okuduðunu ve Kabul Ettiðini G&ouml;sterir.</p>
