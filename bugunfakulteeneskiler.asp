      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bug&uuml;n En Eski</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"><font color="#CC0000"> 
		...
		sql="select * from tiraf where tarih=date() and fakulte like '%"&fakulte&"%' and onay=1 order by id asc"
