  ...
  <tr>
    ...
    <td height="630" colspan="3" align="center" valign="top"><table width="750" height="1148" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#efefef">
      <tr>
		...
		sql="select * from tiraf where tarih >= DateSerial(Year(Date()), Month(Date()), 1) and tarih <= DateSerial(Year(Date()), Month(Date()) + 1, 0) and fakulte like '%"&fakulte&"%' and onay=1 order by populasyon asc"
