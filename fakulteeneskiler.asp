...
<title>T&uuml;m Zamanlar En Eskiler - Gazitiraf.net</title>
  ...
  <tr>
    ...
    <td height="630" colspan="3" align="center" valign="top"><table width="750" height="1148" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#efefef">
      <tr>
		...
		sql="select * from tiraf where fakulte like '%"&qfakulte&"%' and onay=1 order by id asc"
		tiraf.open sql,baglanti,1,3
		else
		fakulte=temizle(request.form("fakulte"))
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where fakulte like '%"&fakulte&"%' and onay=1 order by id asc"
		tiraf.open sql,baglanti,1,3
		end if
