...
<title>Fak&uuml;lteye &Ouml;zel G&ouml;nderiler - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>T&uuml;m Zamanlar</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" />
		...
		sql="select * from tiraf where onay=1 and fakulte like '%" & qfakulte & "%' order by id desc"
		tiraf.open sql,baglanti,1,3
		else
		fakulte=temizle(request.form("fakulte"))
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where onay=1 and fakulte like '%" & fakulte & "%' order by id desc"
		tiraf.open sql,baglanti,1,3
		end if
...
If tiraf.Eof Then Exit For
		...
		sql="Select * from yorum where onay=1 and id=" & tiraf("id") & ""
...
%>
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="left" class="yazi"><strong><%=tiraf("gonderen")%></strong><strong> - <%=tiraf("ek")%> - <strong><font color="#CC0000"><%=tiraf("fakulte")%></font> 
			</strong></strong></td>
		  ...
		  <table width="190" height="464" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="202" valign="top"><div align="center" class="yazi">
                <div align="left">               
<form id="fakulte" method="post" action="fakulteenpopuler.asp" name="fakulte">
...
En Populerler</a>  
            ...
            <tr>
              ...
              <td valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="fakulteeneskiler.asp" name="eneski">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
            ...
            <tr>
              ...
              <td height="15" valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="fakulteenpopusuz.asp" name="enpopusuz">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
            ...
            <tr>
              ...
              <td height="15" valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="fakulteencokyorum.asp" name="encokyorum">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
