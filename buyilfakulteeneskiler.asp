...
<head>
<title>Bu Yýl Fak&uuml;lteye &Ouml;zel En Eskiler - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bu Yýl En Eski G&ouml;nderiler</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"><font color="#CC0000"> 
			  <%=request.form("fakulte")%> Fak&uuml;ltesi Gösteriliyor.</font></span></td>
            </tr>
          </table>
		  <%
		fakulte = request.form("fakulte")
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where tarih >= DateSerial(Year(Date()), 1, 1) and tarih <= DateSerial(Year(Date()), 12, 31) and fakulte like '%"&fakulte&"%' and onay=1 order by id asc"
