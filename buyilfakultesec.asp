      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bu Yýl</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"><font color="#CC0000"> <%=request.form("fakulte")%> Fak&uuml;ltesi Gösteriliyor. </font></span></td>
            </tr>
          </table>
		...
		sql="select * from tiraf where tarih >= DateSerial(Year(Date()), 1, 1) and tarih <= DateSerial(Year(Date()), 12, 31) and onay=1 and fakulte like '%" & fakulte & "%' order by id desc"
		  ...
		  <table width="190" height="464" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="202" valign="top"><div align="center" class="yazi">
                <div align="left">               
<form id="fakulte" method="post" action="buyilfakulteenpopuler.asp" name="fakulte">
...
En Populerler</a>  
            ...
            <tr>
              ...
              <td valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="buyilfakulteeneskiler.asp" name="eneski">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
            ...
            <tr>
              ...
              <td height="15" valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="buyilfakulteenpopusuz.asp" name="enpopusuz">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
            ...
            <tr>
              ...
              <td height="15" valign="top"><div align="center" class="yazi">
                ...
                <form id="fakulte" method="post" action="buyilfakulteencokyorum.asp" name="encokyorum">
                <input type="hidden" name="fakulte" value="<%=request.form("fakulte")%>" />
