...
<title>T&uuml;m Zamanlar En Pop&uuml;lerler - Gazitiraf.net</title>
...
<span class="yazi"><font color="#CC0000"> 
 <%
		...
		sql="select * from tiraf where fakulte like '%"&qfakulte&"%' and onay=1 order by populasyon desc"
		tiraf.open sql,baglanti,1,3
		else
		fakulte=temizle(request.form("fakulte"))
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where fakulte like '%"&fakulte&"%' and onay=1 order by populasyon desc"
		tiraf.open sql,baglanti,1,3
		end if
