      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>G&ouml;nderdiðiniz Tiraflar</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Tiraflar Listeleniyor.</span></td>
            </tr>
          </table>
		  <%
girenid=session("id")
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where onay=1 and girenid="&girenid&" order by id desc"
...
%>
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="6" align="left" class="yazi"><div align="right"></div></td>
          </tr>
          <tr>
