...
<head>
<title>Anasayfa - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>&Ouml;zele Gelen Mesajlar</strong></span></td>
            </tr>
          </table>
		  <%
		alanid=session("id")
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from ozelmesaj where onay=1 and alanid= '"&alanid&"' order by id desc"
...
%><br />
<br />
<font size="-1" face="verdana"><strong><center> Gelen Kutusun Boþ</center></strong></font>
<%
		Else
		gonderenid=tiraf("gonderenid")
		set gonderen=server.createobject("adodb.recordset")
		sql="select * from kullanici where id= "&gonderenid&""
		gonderen.open sql,baglanti,1,3	
...
%>
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="left" class="yazi"><strong>G&ouml;nderen:<font color="#990000"><%=gonderen("kuladi")%></font></strong></td>
            <td colspan="4" class="yazi"><div align="right"><%=tiraf("tarih")%></div></td>
          </tr>
          <tr>
            <td colspan="6" class="yazi">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="6"><div align="left" class="yazi"><%=tiraf("mesaj")%></div></td>
          </tr>
          <tr>
            <td colspan="6">&nbsp;</td>
          </tr>
          <tr>
            <td width="64" class="yazi style5">&nbsp;</td>
            <td width="143" align="left">&nbsp;</td>
            <td width="101"><a href="mesajcevapla.asp?id=<%=tiraf("gonderenid")%>"><img src="gaziresim/cevapla.gif" align="right" /></a></td>
