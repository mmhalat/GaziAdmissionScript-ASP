...
<head>
<title>Ýtiraf&ccedil;ýya Yaz - Gazitiraf.net</title>
  ...
  <tr>
    ...
    <table width="750" height="1148" border="0" cellpadding="0" cellspacing="0" bgcolor="#efefef">
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Mesaj G&ouml;nderme Aracý</strong></span></td>
            </tr>
          </table>
		<%
		gonderilecekid = temizle(request.QueryString("id"))
		...
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <form action="mesajcevapkaydet.asp" class="uniForm" method="post">
            <input type="hidden" name="gonderilecekid" value="<%=gonderilecekid%>" />
      <div id="errorMsg">
        <h3>Göndermeden Önce;</h3>
          <ol>
            <li>Sitenin kalitesini belli bir d&uuml;zeyde tutmak ve eðlence platformunu sa&ccedil;malýklar platformuna d&ouml;n&uuml;þt&uuml;rmemek i&ccedil;in; Buraya yazdýklarýnýn edit&ouml;rler tarafýndan kontrol edilip onay aldýðýný biliyorsun, o y&uuml;zden l&uuml;tfen seviyeyi koru,unutma sen Gazilisin :)</li>
          </ol>
      </div>
      ...
      <div id="okMsg">
        <p>
          Mesajý Gönderdiðimde, Bu Yazdýklarýmdan Benim Sorumlu olduðumu ve Yukarýda Yazanlarý Dikkate Aldýðýmý Kabul Ediyorum.
        </p>
      </div>
      <div class="buttonHolder">
        <button type="submit" class="primaryAction">Cevapla</button>
      </div>

  </form>
        <%else%>
       <font color="#000000" size="-1"><strong><center>
          Kimsin? ,Senin kim olduðunu bilmeden tirafçýya mesaj gönderemeyiz maalesef.<br />
         <a href="uyeol.asp">Kayýt OL!  </a>
       </center></strong></font> 
       <%end if%>
