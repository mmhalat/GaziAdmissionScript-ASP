...
<head>
<title>Bu Yýl En &Ccedil;ok Yorum Alanlar - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bu Yýl</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Fakülteler Gösteriliyor. </span></td>
            </tr>
          </table>
		  <%
		set tiraf = server.createobject("adodb.recordset")
sql="SELECT t.id, t.gonderen, t.ek, t.fakulte, t.tarih, t.baslik, t.icerik, t.populasyon, t.girenid, IIF(ISNULL(ty.yorumsayisi), 0, ty.yorumsayisi) FROM tiraf AS t LEFT JOIN (SELECT tirafid , COUNT(id) AS yorumsayisi FROM Yorum GROUP BY tirafid) AS ty ON t.id=ty.tirafid WHERE t.tarih >= DateSerial(Year(Date()), 1, 1) and tarih <= DateSerial(Year(Date()), 12, 31) ORDER BY ty.yorumsayisi DESC"
		  ...
		  <table width="190" height="464" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi"><strong>Fakülte Seç :</strong>
                 <FORM action="buyilfakultesec.asp" method="post">
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buyilenpopuler.asp">En Popülerler </a></div>
              </div></td>
            </tr>
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buyileneski.asp">En Eskiler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buyilenpopusuz.asp">En Popüsüzler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buyilencokyorum.asp">En Çok Yorumlananlar </a></div>
              </div></td>
            </tr>
            <tr>
