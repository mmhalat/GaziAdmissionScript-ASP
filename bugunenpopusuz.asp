...
<head>
<title>Bug&uuml;n En Pop&uuml;s&uuml;zler - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bugün En Pop&uuml;s&uuml;zler</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Fakülteler Gösteriliyor. </span></td>
            </tr>
          </table>
		  <%

		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where onay=1 and tarih=date() order by populasyon asc "
