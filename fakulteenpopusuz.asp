...
<title>T&uuml;m Zamanlar En Popusuzler - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>T&uuml;m Zamanlar</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> <font color="#CC0000">
			   <%
		...
		sql="select * from tiraf where fakulte like '%"&qfakulte&"%' and onay=1 order by populasyon asc"
		tiraf.open sql,baglanti,1,3
		else
		fakulte=temizle(request.form("fakulte"))
		set tiraf=server.createobject("adodb.recordset")
		sql="select * from tiraf where fakulte like '%"&fakulte&"%' and onay=1 order by populasyon asc"
		tiraf.open sql,baglanti,1,3
		end if
		...
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="3" class="yazi"><div align="right"><%=tiraf("tarih")%></div></td>
          </tr>
          <tr>
