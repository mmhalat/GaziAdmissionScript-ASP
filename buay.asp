...
<title>Bu Ay Yasananlar - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bu Ay</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Fakülteler Gösteriliyor. </span></td>
            </tr>
          </table>
		  <%

		set tiraf=server.createobject("adodb.recordset")
		sql = "select * from tiraf where onay=1 and tarih >= DateSerial(Year(Date()), Month(Date()), 1) and tarih <= DateSerial(Year(Date()), Month(Date()) + 1, 0) order by populasyon desc"
		tiraf.open sql,baglanti,1,3

		Toplam = tiraf.RecordCount
		If Toplam = 0 Then
		intSayfaSayisi = 0
		Response.Write "Tabloda Kayyt Yok"
		Else
...
<a href="?sayfa=1" title="Ylk Sayfa">[««]</a>
		  ...
		  <table width="190" height="464" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi"><strong>Fakülte Seç :</strong>
                ...
                <option selected="selected">Fakülteni Seç Gazili!!</option>
                  <option value="IIBF">IIBF</option>
                  <option value="EGITIM">EGITIM</option>
                  <option value="ILETISIM">ILETISIM</option>
                  <option value="HUKUK">HUKUK</option>
                  <option value="FEN">FEN</option>
                  <option value="EDEBIYAT">EDEBIYAT</option>
                  <option value="DIS HEKIMLIGI">DIS HEKIMLIGI</option>
                  <option value="ECZACILIK">ECZACILIK</option>
                  <option value="MÜHENDISLIK">MÜHENDISLIK</option>
                  <option value="MIMARLIK">MIMARLIK</option>
                  <option value="ENDÜSTRIYEL SANATLAR">ENDÜSTRIYEL SANATLAR</option>
                  <option value="GAZI EGITIM">GAZI EGITIM</option>
                  <option value="GÜZEL SANATLAR">GÜZEL SANATLAR</option>
                  <option value="SAGLIK BILIMLER">SAGLIK BILIMLER</option>
                  <option value="TIP">TIP</option>
                  <option value="SANAT ve TASARIM">SANAT ve TASARIM</option>
                  <option value="MESLEKI EGITIM">MESLEKI EGITIM</option>
                  <option value="TEKNIK EGITIM">TEKNIK EGITIM</option>
                  <option value="TEKNOLOJI">TEKNOLOJI</option>
                  <option value="TICARET ve TURIZM">TICARET ve TURIZM</option>
            ...
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buayenpopuler.asp">En Popülerler </a></div>
              </div></td>
            </tr>
            <tr>
              <td valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buayeneski.asp">En Eskiler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buayenpopusuz.asp">En Popüsüzler </a></div>
              </div></td>
            </tr>
            <tr>
              <td height="15" valign="top"><div align="center" class="yazi">
                <div align="left"><img src="gaziresim/ok.gif" width="13" height="9"><a href="buayencokyorum.asp">En Çok Yorumlananlar </a></div>
              </div></td>
            </tr>
            <tr>
...
<%else%>
                  ...
                  <tr>
                    <td colspan="2"><img src="gaziresim/ok.gif" width="13" height="9" /><a href="tiraflarim.asp" class="style6 style16">Tiraflarym</a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="2"><img src="gaziresim/ok.gif" width="13" height="9" /><a href="cik.asp" class="style6 style16">Çyky?</a></td>
                  </tr>
                </table>
				<%end if%>				</td>
            </tr>
  ...
  <tr>
    <td colspan="3" align="left" valign="top" bgcolor="#EFEFEF"><div align="center" class="style6">Bir Gazi &#304;&#351;letme Ö&#287;rencisi Projesidir :) 
    <br />
    GaziT&#304;RAF © 2013</div></td>
  </tr>
</table>
