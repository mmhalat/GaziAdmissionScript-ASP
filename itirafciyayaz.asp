  ...
  <tr>
    ...
    <table width="750" height="1148" border="0" cellpadding="0" cellspacing="0" bgcolor="#efefef">
      <tr>
		...
		<table width="495" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <form action="mesajgonder.asp" class="uniForm" method="post">
            <input type="hidden" name="gonderilecekid" value="<%=temizle(request.QueryString("id"))%>" />
      <div id="errorMsg">
      ...
      <div class="buttonHolder">
        ...
        <%else%>
       <font color="#000000" size="-1"><strong><center> Kimsin? ,Senin kim olduðunu bilmeden itirafçýya mesaj gönderemeyiz maalesef.<br />
