...
<title>Bu Hafta Yasananlar - Gazitiraf.net</title>
      ...
      <tr>
        ...
        <td width="505" valign="top">
		  ...
		  <table width="512" height="19" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="yazi style3"><strong>Bu Hafta</strong></span> <img src="gaziresim/ok.gif" width="13" height="9" /><span class="yazi"> Tüm Fakülteler Gösteriliyor.</span></td>
            </tr>
          </table>
		  <%

		set tiraf=server.createobject("adodb.recordset")
		sql = "select * from tiraf where onay=1 and tarih <= (Date() - Weekday(Date(), 2) + 2) and tarih >= (Date() - Weekday(Date(), 2) -5) order by populasyon desc"
...
<%else%>
  ...
  <tr>
    <td colspan="3" align="left" valign="top" bgcolor="#EFEFEF"><div align="center" class="style6">Bir Gazi Y?letme Ö?rencisi Projesidir :) 
    <br />
    GaziTYRAF © 2013</div></td>
  </tr>
</table>
